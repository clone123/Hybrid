...
// Populate the class2type map
    jQuery.each("Boolean Number String Function Array Date RegExp Object Error".split(" "), function(i, name) {
        class2type[ "[object " + name + "]" ] = name.toLowerCase(); // 小写
    });
    ...
    e(document).ready(function() {
        ...
        "MSGesture" in window && (f = new MSGesture(), f.target = document.body), e(document).bind("MSGestureEnd", function(e) {
            ...
            t && (d.el && d.el.trigger("swipe"), d.el && d.el.trigger("swipe" + t));
                ...
                (!(v = a(t, "down")) || o(t)) && (g = v ? t : t.originalEvent.touches[0], t.originalEvent.touches && 1 === t.originalEvent.touches.length && d.x2 && (d.x2 = void 0,
                ...
                (!(v = a(e, "move")) || o(e)) && (g = v ? e : e.originalEvent.touches[0], i(), d.x2 = g.pageX,
...
$.browser = $.browser || {},
$.browser.ios = /iPhone|iPod|iPad/i.test(ua), $.browser.iphone = /iPhone/i.test(ua),
$.browser.ipad = /iPad/i.test(ua), $.browser.android = /Android/i.test(ua), $.browser.android4 = /Android\s4/i.test(ua),
