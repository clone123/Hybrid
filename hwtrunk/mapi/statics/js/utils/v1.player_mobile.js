...
!function(a) {
    ...
    (b),
    tvp = {},
    tvp.lastModify = "2016-01-27 09:49:12",
    tvp.ts = tvp.lastModify.replace(/\D/g, ""),
    tvp.ver = "$V2.0Build7121$",
    tvp.dataset = {
        openLazy: !0
    },
    tvp.name = "\u817e\u8baf\u89c6\u9891\u7edf\u4e00\u64ad\u653e\u5668",
    ...
    function(a) {
        var b = {
            ...
            setData: function(a, b) {
                return window.localStorage ? (window.localStorage[a] = b,
                !0) : void 0
            },
            delData: function(a) {
                return window.localStorage ? (window.localStorage.removeItem(a),
                !0) : void 0
            },
        ...
        a.app = {
            ...
            getOpenUrl: function(d) {
                ...
                (d.cid || d.h5Url) && parseInt(d.pay)) {
                    ...
                    b.os.iphone ? (f = g,
                    d.openUrl = f) : d.version && parseInt(d.version) < 5852 && (f = g)
                }
            ...
            report: function(c, d) {
                ...
                c && (c = b.extend(c, e),
                a.report(c),
                3537 === c.cmd && a.bossReport && a.bossReport.appReportShowClick && a.bossReport.appReportShowClick(c, d))
            },
    ...
    tvp.bossReport = {
        ...
        appReportShowClick: function(a, b) {
            var c = "http://btrace.video.qq.com/kvcollect?BossId=3267&Pwd=1887953802&"
              , d = {
                cmd: -1,
                url: window != top ? document.referrer : document.location.href,
                ver: tvp.ver.replace(/\$/g, ""),
    ...
    function(a, b) {
        ...
        function j(d) {
            ...
            if ("object" == typeof e && "function" == typeof e.$xx && "string" == typeof d) {
                ...
                k && (i = i + "&_qv_rmt=" + k.u1,
                i = i + "&_qv_rmt2=" + k.u2,
                b.getUrlParam("sdtfrom", d) || (i = i + "&sdtfrom=" + h),
                d = d + (-1 == d.indexOf("?") ? "?" : "&") + i,
                b.cookie.set("qv_als", k.c))
            }
            return d
        }
        var k = {
                ...
                var A = function(d) {
                  ...
                  , C = function() {
                    ...
                    b.ajax({
                        ...
                        return !e.noAuth && b && 0 != b.em && "o" != b.s ? 85 === b.em && -3 === b.type && 1 === e.cgi_auth_index ? (e.cgi_auth_index += 1,
                        e.defer = q,
                        e.needTime = !0,
                        e.svr_time = b.curTime,
                        void a.h5Helper.loadVideoUrlByVid(e)) : (e.noAuth = !0,
                        e.defer = q,
                        void a.h5Helper.loadVideoUrlByVid(e)) : void A(b)
                    }
                    ).fail(function() {
                        s.reportErr(),
                        y({
    ...
    function(a, b) {
        a.BasePlayer = function() {
            ...
            this.instance = null ,
            this.dataset = {},
            this.eventList = ["inited", "play", "playing", "ended", "allended", "pause", "resume", "timeupdate", "getnext", "error", "stop", "fullscreen", "change", "write", "flashpopup", "getnextenable", "msg", "h5loadingadstart", "h5loadingadend", "volumechange"],
            this.config = {},
...
/*                this.config.isHtml5UseUI && (b.os.iphone || b.os.ipod) && this.config.isIOSVideoOffset && !this.config.isiPhoneShowPlaysinline && (c += 'style="position:absolute;top:-200%;left:-200%"'),
            ...
            checkPlayerSize: function() {
                function a() {
                    b.isFullScreen || setTimeout(function() {
                        ...
                        d.toString().indexOf("%") > -1 || f > e && (f = parseInt(9 * e / 16, 10),
                        e = a,
                        b.resize(e, f))
                    }
                    , 100)
                ...
                this.config.isCheckPlayerSize && c && (a(),
    ...
    function(a, b) {
        ...
        function d(c, d) {
            ...
            var j = function(c, e) {
                ...
                d && d.config && (f.contentId = d.config.contentId,
                f.appId = d.config.appid || d.config.appId),
                e = e || {},
                f = b.extend(f, e),
                a.report(f)
            }
              ...
              , m = 1e4
              , n = function() {
                c.currentTime != e || g ? (g = !0,
                k && !l && (j(f, {
                    int5: 1
                }),
                l = !0)) : (f++,
                c.play(),
                f % 10 === 0 && c.currentTime === e && (c.load(),
                c.play(),
                k || (j(f),
                k = !0),
                h = setTimeout(n, m)))
        ...
        function e(c, d) {
            ...
            b.extend(this.h5EvtAdapter, {
                ...
                onPause: function() {
                    ...
                    this.callCBEvent("onpause", g, this.$video),
        ...
        if (!a.Html5Tiny) {
            ...
            b.extend(e.prototype, {
                ...
                report_playtime: function(c) {
                    var d = {
                        ptime: c.ptime,
                        url: c.url || top.location.href,
                        platform: a.common.getDeviceId(),
                        ctime: c.currentTime,
                        vid: c.vid,
                        pagetype: a.app && a.app.pageType ? a.app.pageType : 0,
                        host: top.location && top.location.hostname ? top.location.hostname : window.location.hostname
                    }
                      , e = new Image
            ...
            b.extend(e.prototype, {
                ...
                play: function(c, d, e) {
                    function h(e) {
                        ...
                        var j, k, l = e ? i.curVideo.getHLS : i.curVideo.getMP4Url, m = i.curVideo.getVid();
                        i.curVideo && m && (i.curVideo.defer_cache || (i.curVideo.defer_cache = {
                            ad: {},
                            vd: {}
                        }),
                        !e && i.curVideo.callGetMp4UrlDefer && i.curVideo.callGetMp4UrlDefer.done(function(a) {
                            a && b.isFunction(a.done) && (i.curVideo.defer_cache.vd[m] = a,
                            i.curVideo.callGetMp4UrlDefer = null )
                        }
                        ),
                        i.curVideo.defer_cache.vd[m] || (i.curVideo.defer_cache.vd[m] = l.call(i.curVideo, c, i.isPlayingSplit)),
                        i.curVideo.defer_cache.ad[m] || (i.curVideo.defer_cache.ad[m] = b.Deferred()),
                        a.Html5UI && b.isFunction(a.Html5UI.fn.buildloadingAd) && i.config.isHtml5UseUI && (i.config.isHtml5ShowLoadingAdOnStart || i.config.isHtml5ShowLoadingAdOnChange) ? (i.$video.attr("tvp_loadingad_ended", 1),
                        i.$video.off("tvp:loadingad:ended").on("tvp:loadingad:ended", function(a, c) {
                            var d = c.vid || "";
                            if (d) {
                                if (!i.curVideo.defer_cache.vd[d])
                                    return void (j ? (i.videoTag.src = j,
                                    i.videoTag.load(),
                                ...
                                j && k(j, i.config.autoplayAfterLoadingad && !c.emptyAd),
                                i.curVideo.defer_cache.ad[d] || (i.curVideo.defer_cache.ad[d] = b.Deferred()),
                                i.curVideo.defer_cache.ad[d].resolve()
                            }
                        }
                        )) : i.curVideo.defer_cache.ad[m].resolve(),
                        i.curVideo.defer_cache.vd[m].done(function(b) {
                            if (j = b,
                        ...
                        k = function(a, c) {
                            ...
                            i.curVideo.defer_cache.vd[m] = null ,
                            i.curVideo.defer_cache.ad[m] = null ,
                        ...
                        ,
                        b.when(i.curVideo.defer_cache.vd[m], i.curVideo.defer_cache.ad[m]).done(function(a) {
                           // a =  window['v1_videoSrc']; //a || j;
                    ...
                    if (c instanceof a.VideoInfo) {
                        ...
                        i.isPlayingSplit && f && i.getCurVid() === c.getVid())
                            return;
                ...
                checkPause: function() {
                    ...
                    h = setInterval(function() {
                        ...
                        a.length >= 2 && (0 == Math.abs(a[0] - a[1]) ? (h && clearInterval(h),
                        a = [],
                        b.videoTag.load(),
                        b.videoTag.play()) : h && clearInterval(h),
                        a = []))
                    }
                    , 500)
                },
            ...
            b.extend(this.h5EvtAdapter, {
                ...
                onPlaying: function() {
                    ...
                    setTimeout(function() {
                        ...
                        d.report_h5_live({
                            firstload: (d.report_time.onplaying - d.report_time.onplay) / 1e3,
                            firstreport: 1,
                            playno: i,
                            blocktime: 0,
                            block: 0,
                ...
                onError: function(d, e) {
                    ...
                    c(f, 0);
                    var g = -1;
                    e.target && e.target.error && (g = e.target.error.code),
                    this.report_h5_live({
                        errcode: g,
                        playno: i
                    }),
        ...
        if (!a.Html5LiveTiny) {
            ...
            b.extend(g.fn, {
                ...
                play: function(c, f) {
                    ...
                    if (m) {
                        if (!/.*\.?qq\.com$/.test(n.host) && !/.*\.?qq\.com$/.test(m))
                            throw e(10, {
                                config: j.config
                            }),
                        ...
                        var r = b.now();
                        b.ajax({
                            url: a.common.get_request_url("zb"),
                            data: n,
                            dataType: "jsonp"
                        }).done(function(d, f) {
                            j.rs_cache = d,
                            f = b.now() - r,
                            d && 0 == d.iretcode || p.reject(),
                            d.playurl ? (e(12, {
                                delay: f,
                                config: j.config
                            }),
                    ...
                    b.when(p, q).done(function(a) {
                        g(o)
                    }
                    ).fail(function() {
                        j.h5EvtAdapter.onError.call(j, null , {})
                    }
                    )
                },
                ...
                report_h5_live: function(c) {
                    ...
                    var d = this
                      ...
                      , l = a.common.getDeviceId()
                      , m = c.playno || a.$.newGuid()
                      , n = f(c.firstload)
                      , o = f(c.errcode) || 0
                      , p = f(c.blocktime)
                      , q = f(c.block)
                      ...
                      , u = new Image
                      , v = "http://btrace.video.qq.com/kvcollect?BossId=2727&Pwd=1424084450&_dc=" + Math.random();
                    v += "&" + b.param(t),
                    u.src = v
                },
                isPlayingLoadingAd: function() {
        ...
        b.extend(c.prototype, {
            build: function(c, e) {
                if (c && 1 === c.config.type && !(a.app && !a.app.isSupportApp || a.common.isLiveUseHTML5() && !e)) {
                    ...
                    g.iframe = window != top ? 'target="_parent"' : "",
                    g.url = a.app.getDownloadUrl(),
                    this.renderData = g,
                    f = b.formatTpl(f, g),
                    this.t = c,
                    ...
                    this.$mod = h,
                    h.addClass("tvp_container"),
                    this.element = b(f).appendTo(h),
            ...
            _bindEvents: function() {
                ...
                this.$btn.on(a, function() {
                    c._report(1),
                    d && d.$btn && d.$btn.trigger && d.$btn.trigger(a)
                }
                )
            },
            _report: function(b) {
            ...
            show: function() {
                this.enable && (this.t.hidePlayer(),
                this.element && this.element.show(),
                this.isShow = !0,
                this._report(0))
            },
            hide: function() {
                this.enable && (this.element && this.element.hide(),
                this.isShow = !1)
            }
        })
    }
    ...
    function(a, b) {
        ...
        var d = {
          ...
          , g = {
            initEvent1: function() {
                ...
                this.$video.off("pause.limit").on("pause.limit", function() {
                    a.player.isTouching || this.ended || (a.player.isTouching || a.$limitPlay.removeClass(f.HIDE),
                ...
                this.$video.off("timeupdate.limit").on("timeupdate.limit", function() {
                    a.showDownload && (a.remain = parseInt(this.duration - this.currentTime),
            ...
            initEvent2: function() {
                ...
                this.$video.on("pause", function() {
                    a.player.isTouching || this.ended || (a.$panel.removeClass(f.HIDE),
          ...
          , h = {
            ...
            clickReport: function() {
                ...
                )) : (b.os.ios || 2 === a.type) && (a.stepReport(1, 1),
                a.$btn.off("touchend.stepreport").on("touchend.stepreport", function() {
                    a.stepReport(2, 1)
                }
                ))
        ...
        c.prototype = {
            init: function(b) {
                return b && 1 != b.config.type && b.config.isHtml5UseUI && !b.config.isShortVideo ? (this.player = b,
                this.$video = b.$video,
                ...
                a.app && a.app.isSupportApp ? void (0 !== this.type && (this.enable && b.trigger && b.trigger("tvp.durationlimit.enable"),
                this.start())) : void (this.enable && this.macLimit())) : void 0
            },
            ...
            hasLimit: function() {
                ...
                return a && a.exem && a.preview ? (this.player.curVideo.setDuration(a.preview.toString()),
                this.preview = a.preview,
                this.remain = a.preview,
                !0) : !1
            },
            ...
            check: function() {
                ...
                return this.conf.promotionId && d.conf.downloadUrl ? (this.getMD5().done(function() {
                    return d.conf.md5 ? void a.app.check({
                        ...
                        "undefined" === b.type(d.conf.openUrl) && (d.conf.openUrl = a.openUrl),
                        d.conf.url = a.url),
                        c.resolve()
                    }
                    ) : void c.reject()
        ...
        b.extend(a.Html5Tiny.fn, {
            buildmonitor: function() {
                ...
                this.$video.on("tvp:video:ajaxstart", function(b, e, g) {
                    ...
                    1 != ++e && (c.isDefinitionSwitching || c.isTouching || (d.addStep(31),
    ...
    function(a, b) {
        ...
        a.Html5Bullet.prototype = {
            ...
            start: function() {
                ...
                this.show(),
                a.text_list.unshift(c.null_tips),
                a.add_bullet(),
            ...
            init_events: function() {
                var c = this
                  , d = "click";
                d = "fastclick",
                a.fastclick(this.$switch),
                this.$switch.off(d).on(d, function() {
                    var b = c.check_switch()
                      , d = b ? 0 : 1;
                    b ? (c.set_switch_close(),
                    c.stop(),
                    c.update_switch_db_status()) : (c.set_switch_open(),
                    c.check_video() && c.start(),
                    c.update_switch_db_status(1)),
                ...
                var e = function() {
                    ...
                    , 200),
                    c.reset_animate_speed()
                }
                ;
                b(window).off("orientationchange", e).on("orientationchange", e),
                this.player.$mod.off("tvp:bullet:enterfullscreen").on("tvp:bullet:enterfullscreen", e),
                this.player.$mod.off("tvp:bullet:cancelfullscreen").on("tvp:bullet:cancelfullscreen", e);
                var f = function() {
    ...
    function(a, b) {
        b.extend(a.Html5UI.fn, {
            buildoverlay: function(c, d, e, f) {
                ...
                ).on("playing", p).on("pause", q).on("seeking", r).on("seeked", s).on("tvp_adonend_ended", u),
                ...
                var y = function() {
                  ...
                  , z = function() {
                    return c.isPlayingSplit ? void y() : (d.trigger("tvp:player:videoreplay"),
                    void (c.config.isHtml5ShowLoadingAdOnStart && c.config.isHtml5ShowLoadingAdOnReplay || (g.load(),
                    g.play(),
                    o.hideReplay(),
                    o.hidePlay(),
                    o.showLoading())))
    ...
    function(a, b) {
        ...
        b.extend(a.Html5UI.fn, {
            ...
            enterFullScreen: function() {
                this.player.videoTag && 0 == this.player.videoTag.currentTime && b.os.ipad || (top === window || top.location.href || b.os.ios) && (this.player.config.isHtml5UseFakeFullScreen ? this.allEnterFullScreen() : this.enterRealFullScreen(),
            ...
            cancelRealFullScreen: function() {
                var a = this
                  ...
                  , c = b[0];
                this.fixClassName(0),
                document.webkitExitFullscreen && c.webkitExitFullscreen()
            },
            allCancelFullScreen: function() {
                ...
                if (a && c)
                    try {
                        frameElement && (frameElement.style.cssText = e),
            ...
            allEnterFullScreen: function() {
                ...
                if (a && c)
                    try {
                        frameElement && (e = frameElement.style.cssText,
                        b(frameElement).css({
            ...
            cancelFakeFullScreen: function() {
                ...
                try {
                    top.document.body.scrollTop = d
                } catch (a) {}
                f && (this.player.$videomod[0].style.cssText = f),
            ...
            listenOrientationChange: function() {
                var a = this.player
                  ...
                  , e = function() {
                    var e = top.innerWidth
                      , f = top.innerHeight;
                    g.s0 && g.s1 && (90 === Math.abs(top.orientation) ? (e = g.s1.width,
                    f = g.s1.height) : (e = g.s0.width,
                    f = g.s0.height)),
                    window !== top && b(frameElement).css({
                        position: "fixed !important",
                    ...
                    c.isRotate = !1,
                    top.document.body.scrollTop = d + 30,
                    setTimeout(function() {
                        top.document.body.scrollTop = d - 30
                    }
                    , 10),
                ...
                try {
                    ...
                    b(top).off("orientationchange.fullscreen").on("orientationchange.fullscreen", function() {
                        return b.os.ipod ? void e() : void (g.s0 && g.s1 ? e() : c.androidScreenCalc(e))
                    }
                    ),
            ...
            androidScreenCalc: function(a) {
                ...
                ,
                g.times >= 2 || (g.times += 1,
                g.calcTimer = setInterval(function() {
                    c.setCalcValue(),
                    g.changeTimes >= 1 && (clearInterval(g.calcTimer),
                    g.calcTimer = null ,
                    setTimeout(function() {
                        c.setCalcValue(),
                        a()
                ...
                , 100),
                setTimeout(function() {
                    g.calcTimer && clearInterval(g.calcTimer),
                    c.setCalcValue(),
                    a()
                }
                , 2e3))
            ...
            setCalcValue: function() {
                ...
                90 === Math.abs(top.orientation) ? (g.s1 && g.s1.width !== a.width && g.changeTimes++,
                g.s1 = a) : (g.s0 && g.s0.width !== a.width && g.changeTimes++,
                g.s0 = a)
            },
            ...
            buildposterlayer: function(c, d, e, f) {
                var g = f.find(a.html5skin.elements.posterlayer.main)
                  ...
                  , j = function(a) {
                    ...
                    h.attr("src", a),
                    (!b.os.ios || b.os.ios && b.compareVersion(b.os.version, "8.0") > -1) && d.attr("poster", a),
                    k()) : l(),
    ...
    function(a, b) {
        function c(b, c, d, e) {
            ...
            c.on("tvp:player:videochange", function() {
                b.config.isHtml5ShowLoadingAdOnChange && (c.attr("data-playing-loadingad", "1"),
                f.getAdData())
            }
            ),
            c.on("tvp:player:videoreplay", function() {
                b.config.isHtml5ShowLoadingAdOnStart && b.config.isHtml5ShowLoadingAdOnReplay && (c.attr("data-playing-loadingad", "1"),
                f.getAdData())
            }
            ),
            f.onEnd = function(a) {
                a = a || {},
                g.addClass("tvp_none"),
                c.attr("data-playing-loadingad", "0");
                var d, e = function() {
                    var f = "1" === c.attr("tvp_loadingad_ended");
                    f ? c.trigger && c.trigger("tvp:loadingad:ended", {
                        vid: b.curVideo.getVid(),
                        emptyAd: !(!a || !a.noOrder)
                ...
                , 6e3),
                e(),
                b.callCBEvent("onh5loadingadend")
            }
            ,
            f.onStart = function() {
                c.attr("data-playing-loadingad", "1"),
                g.removeClass("tvp_none"),
                b.callCBEvent("onh5loadingadstart")
            }
            ,
            f.create(b, {
                $container: g,
            ...
            buildloadingAd: function(d, e, f, g) {
                function h() {
                    if (!d.loadingadInited) {
                        ...
                        !d.config.isHtml5ShowLoadingAdOnStart || d.curVideo.getPay())
                            return e.trigger && e.trigger("tvp:loadingad:ended", d.curVideo.getVid()),
                            void (d.curVideo.getPay() && (d.config.isHtml5ShowLoadingAdOnStart = !1,
                            d.config.isHtml5ShowLoadingAdOnChange = !1));
    ...
    function(a, b) {
        ...
        c.prototype = {
            ...
            requestData: function() {
                ...
                return "https:" === location.protocol && (d = "https://sec.video.qq.com/p/bullet.video/fcgi-bin/comment/news_hotlist?vid=" + c.vid),
                b.Ajax({
                    url: d,
    ...
    function(a, b) {
        ...
        b.extend(a.BaseFlash.prototype, {
            ...
            getFlashHTML: function() {
                ...
                this.config.playerid ? this.playerid = this.config.playerid : this.playerid = "tenvideo_flash_player_" + (new Date).getTime();
            ...
            write: function(c) {
                ...
                d) {
                    ...
                    window.jQuery ? jQuery(d).html('<div id="' + j + '">' + e + "</div>") : d.innerHTML = '<div id="' + j + '">' + e + "</div>",
            ...
            listenerFlashCrash: function() {
                function c() {
                    if (e) {
                        var b = {
                          ...
                          , c = new Image(1,1);
                        c.src = "http://btrace.video.qq.com/kvcollect?BossId=3353&Pwd=1856399576&_dc=" + Math.random() + "&" + a.$.param(b)
                    }
                }
                function d() {
                ...
                if (!this.timer_flash_crash && this.flashobj && "function" === b.type(this.flashobj.getFPInfo)) {
                    ...
                    this.timer_flash_crash = setInterval(function() {
                        var a;
                        "function" === b.type(f.flashobj.getFPInfo) ? (a = f.flashobj.getFPInfo()) && (e = a) : (clearInterval(f.timer_flash_crash),
                        c())
                    }
                    , 15e3)
                }
    ...
    function(a, b) {
        ...
        ,
        window.toggleFakeFullScreen = function(b, c) {
            var d;
            c && c.id && a.Player && a.Player.instance && (d = a.Player.instance[c.id] || {})
        }
        ,
        ...
        b.extend(a.FlashPlayer.fn, {
            play: function(e) {
                ...
                if (this.curVideo.getVidList() != e.getVidList() || 0 == e.getIdx()) {
                    ...
                    "function" == typeof this.flashobj.loadAndPlayVideoV2 && this.flashobj.loadAndPlayVideoV2(m)
                } else
    ...
    function(a, b) {
        ...
        function e(c, d) {
            ...
            var f = b.Deferred();
            a[e] = f;
            var g = "//imgcache.qq.com/tencentvideo_v1/tvp/js/"
              , h = c.toLowerCase();
            ...
            if ("function" == typeof a[c])
                ...
                j.begin(),
                d(1),
                b.getScript(i, function() {
                    var e = b.now() - k;
                    if ("function" != typeof a[c])
                        throw j.reportErr(11),
                        d(2, 11, e),
                        new Error(errMsg[1]);
                    d(2, 0, e),
                    j.reportSuc(),
        ...
        b.extend(a.Player.fn, {
            ...
            create: function(e) {
                ...
                var g = function() {
                    h(f.config, f).done(function(d, g) {
                        try {
                            c(3, f.sessionId, {
                        ...
                        f.config.type == a.PLAYER_DEFINE.LIVE && (f.play = function(c) {
                            ...
                            c = f.config.video) : c instanceof a.VideoInfo && b.when(h.checkLivePlayer(c)).then(function() {
    ...
    function(a, b) {
        ...
        var d = {
            ...
            downloader: !0,
            range: [1, 2],
            tpl: ['<div class="tvp_app_banner">', '<a data-action="applink" data-role="appbannerlink" data-status="down" href="${url}" data-url="${openUrl}" ${iframe} class="tvp_app_btn">', '<div class="tvp_progress">', '<div class="tvp_progress_current" data-role="appbannerbtnprogress"></div>', "</div>", '<div class="tvp_btn_text" data-role="appbannerbtntext" data-text="${btnText}">', '<div class="tvp_app_logo" style="background-image:url(http://i.gtimg.cn/qqlive/images/20150722/tvp_app_logo.png)"></div>', "</div>", "</a>", "</div>"].join("")
        };
        b.extend(c.prototype, {
            init: function(a) {
                var c = this;
            ...
            stepReport: function(c, d) {
                var e = this
                  , f = {
                    cmd: 3537,
                    int5: c,
                    str4: e.info.hasApp ? 3 : 1,
                    str8: b.getUrlParam("mmuin"),
                    val: 1,
                    _t_: +new Date
                }
                  , g = d.t;
                f.int6 = this.getCurPromotionId(d),
                a.app.report(f, g)
            },
            ...
            showtips: function() {
                var a, b, c = this.op, d = this.info;
                d.hasApp > 0 ? c.btnText = c.btnTexts[d.hasApp] : "",
                c.recmdText && c.btnText.indexOf("\uff0c") > -1 ? c.btnText = c.btnText.split("\uff0c")[0] + "\uff0c" + c.recmdText : c.recmdText && this.$text2 && this.$text2.text(c.recmdText),
                this.canCheckApp() ? (a = c.btnText,
                b = c.btnText) : (a = "\u5230",
                b = this.$text2 && this.$text2.length ? "\u53bbApp\u770b" : c.btnText.replace(/^\u4e0b\u8f7d/, "\u5230")),
                c.text1 = a + c.text1,
                this.$text1.text(c.text1),
                this.$text2 && this.$text2.length ? this.$btnText.text(b) : this.$btnText.attr("data-text", b),
                this.$btn.attr("href", d.url),
                this.$btn.attr("data-url", d.openUrl),
                c.isAutoReport && this.report(0),
                1 == d.hasApp && this.fixDownloadStatus(5)
            },
            ...
            bindTap: function() {
                ...
                1 != d.info.hasApp && (a.app.bindTryOpenAppBanner && a.app.bindTryOpenAppBanner(d),
                b.os.android && !e.downloadUrl && (e.downloadUrl = a.app.getDownloadUrl(!1, e.appName)),
                b.os.android && a.app.getAppMd5(e.promotionId, e.appName).done(function(a) {
                    a && a.md5 && (e.md5 = a.md5,
                    a.url ? e.downloadUrl = a.url : "",
                    a.url && d.$btn.attr("href", a.url),
                    c())
                }
                ))
            },
        ...
        b.extend(b, {
            createAppBanner: function(a) {
                ...
                e.fixResult().done(function() {
                    e.info.hasApp ? e.stepReport(6, a) : b.os.ios && e.stepReport(1, a),
                    d.resolve(e)
                }
                ),
                d
    ...
    function(a, b) {
        b.extend(a.Player.fn, {
            buildAppBannerOnPause: function(c) {
                if (!a.$.browser.IEMobile && !(this.flashobj || a.app && !a.app.isSupportApp || !this.$videomod || b.os.android && b.browser.MQQ && !b.browser.WeChat || !this.config.isHtml5UseUI)) {
                    var d = this
                      , e = b.extend({}, c || {}, {
                        t: d,
                        vid: d.curVideo.getVid(),
    ...
    (tvp.$),
    tvp.filename = "v1.player_mobile.js",
